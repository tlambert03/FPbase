...
ROOT_DIR = environ.Path(__file__) - 3  # (fpbase/config/settings/base.py - 3 = fpbase/)
APPS_DIR = ROOT_DIR.path('fpbase')
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'fpbase.contrib.sites.migrations'
}
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///fpbase'),
}
