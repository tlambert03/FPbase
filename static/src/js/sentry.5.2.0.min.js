...
var Sentry = (function (n) {
        ...
        (n.prototype.add = function (n) {
          ...
          return this.isReady()
            ? (-1 === this.h.indexOf(n) && this.h.push(n),
              ...
              n)
            : Promise.reject(
                new a('Not adding Promise due to buffer limit reached.')
              )
        }),
  ...
  function F(n, t) {
    return (
      void 0 === t && (t = 0),
      0 === t ? n : n.length <= t ? n : n.substr(0, t) + '...'
    )
  }
  function U(n, t) {
  ...
  var W = (function () {
      function n(n) {
        ...
        ;(this.l = L.PENDING),
          ...
          (this.m = function (n, r) {
            t.l === L.PENDING &&
              (m(n) ? n.then(t.p, t.g) : ((t.j = n), (t.l = r), t._()))
          }),
          (this._ = function () {
            t.l !== L.PENDING &&
              (t.l === L.REJECTED
    ...
    X = (function () {
      ...
      return (
        ...
        (n.prototype.setTag = function (n, t) {
          var r
          return (
            (this.L = u({}, this.L, (((r = {})[n] = C(t)), r))), this.U(), this
          )
        }),
        ...
        (n.prototype.setExtra = function (n, t) {
          var r
          return (
            (this.M = u({}, this.M, (((r = {})[n] = C(t)), r))), this.U(), this
          )
        }),
        ...
        (n.prototype.applyToEvent = function (n, t) {
          return (
            this.M &&
              ...
              (n.extra = u({}, this.M, n.extra)),
            this.L &&
              Object.keys(this.L).length &&
              (n.tags = u({}, this.L, n.tags)),
            this.C &&
              Object.keys(this.C).length &&
              (n.user = u({}, this.C, n.user)),
            this.F &&
              Object.keys(this.F).length &&
              (n.contexts = u({}, this.F, n.contexts)),
            this.q && (n.level = this.q),
            this.H && (n.transaction = this.H),
            this.W &&
              ((n.contexts = n.contexts || {}), (n.contexts.trace = this.W)),
            this.B(n),
      ...
      return (
        (n.prototype.G = function (n) {
          ...
          i &&
            i.client &&
            i.client[n] &&
            (t = i.client)[n].apply(t, s(r, [i.scope]))
        }),
  ...
  var hn,
      ...
      return (
        ...
        (n.prototype.captureMessage = function (n, t, r, e) {
          ...
          return (
            (this.rn = !0),
            (d(n)
              ? this.cn().eventFromMessage('' + n, t, r)
              : this.cn().eventFromException(n, r)
            )
              .then(function (n) {
                return i.sn(n, r, e)
              })
        ...
        (n.prototype.sn = function (n, t, r) {
          ...
          return this.hn()
            ? 'number' == typeof u && Math.random() > u
              ? W.reject('This event has been sampled, will not send event.')
              : new W(function (i, u) {
                    ...
                    if (null !== n) {
                      ...
                      try {
                        if ((t && t.data && !0 === t.data.__sentry__) || !o)
                          return e.cn().sendEvent(r), void i(r)
                        var c = o(n, t)
                        if (void 0 === c)
                          k.error(
    ...
    dn = (function () {
      function n(n) {
        ;(this.in = n),
          this.in.dsn ||
            k.warn('No DSN provided, backend will not do anything.'),
          (this.pn = this.mn())
      }
      return (
  ...
  var pn = (function () {
      ...
      return (
        ...
        (n.prototype.yn = function (n) {
          return (
            ...
            {
              blacklistUrls: s(
                this.in.blacklistUrls || [],
                n.blacklistUrls || []
              ),
              ignoreErrors: s(
                this.in.ignoreErrors || [],
                n.ignoreErrors || [],
                mn
              ),
              ignoreInternal:
                void 0 === this.in.ignoreInternal || this.in.ignoreInternal,
              whitelistUrls: s(
                this.in.whitelistUrls || [],
                n.whitelistUrls || []
              ),
            }
          )
    ...
    bn = Object.freeze({ FunctionToString: pn, InboundFilters: yn }),
    wn = b(),
    gn = { Sn: !1, On: !1, kn: !1, Tn: !1 },
    En = '?',
    jn =
  ...
  ;(gn.Sn = (function () {
    ...
    function c(t, r, e, c, s) {
      var l = null
      if (((s = h(s) ? s.error : s), (t = h(t) ? t.message : t), i))
        gn.kn.Rn(i, r, e, t), a()
      else if (s && f(s)) ((l = gn.kn(s)).mechanism = 'onerror'), o(l, !0, s)
      else {
        var v,
          d = { url: r, line: e, column: c },
          p = t
    ...
    (gn.kn = (function () {
      function n(n) {
        ...
        return f.length
          ? (f[0] && f[0].line && !f[0].column && h && (f[0].column = null),
            { mode: 'stack', name: n.name, message: n.message, stack: f })
          : null
      }
      function t(n, t, r, e) {
        var i = { url: t, line: r }
        if (i.url && i.line) {
          if (
            ...
            if (!n.stack[0].line && n.stack[0].func === i.func)
              return (
                (n.stack[0].line = i.line), (n.stack[0].context = i.context), !1
              )
          }
        ...
        for (
          ...
          if (f !== Tn && f !== gn.Sn) {
            if (
              ...
              f.name
                ? (o.func = f.name)
                : (i = u.exec(f.toString())) && (o.func = i[1]),
              void 0 === o.func)
            )
              try {
            ...
            (i = (function (n) {
              ...
              var r,
                ...
                c =
                  wn &&
                  wn.document &&
                  wn.document.getElementsByTagName('script'),
                s = []
              ...
              return u.length
                ? { mode: 'multiline', name: n.name, message: t[0], stack: u }
                : null
            })(t))
          )
            return i
  ...
  function Nn(n) {
    ...
    var t = n,
      ...
      e = t[t.length - 1].func || ''
    return (
      (r.includes('captureMessage') || r.includes('captureException')) &&
        (t = t.slice(1)),
    ...
    $n = (function (t) {
      ...
      return (
        ...
        (e.prototype.mn = function () {
          ...
          var n = this.in.transportOptions
            ? this.in.transportOptions
            : { dsn: this.in.dsn }
          return this.in.transport
            ? new this.in.transport(n)
            : q()
            ? new Fn(n)
            : new Un(n)
        }),
        (e.prototype.eventFromException = function (t, r) {
          var e,
            ...
            o = this
          if (h(t) && t.error)
            return (t = t.error), (e = In(Tn(t))), W.resolve(this.Cn(e, r))
          if (
            l(t) ||
            ((i = t),
            ...
            return this.eventFromMessage(s, n.Severity.Error, r).then(
              function (n) {
              ...
              x(
                (e = (function (n, t) {
                  var r = Object.keys(n).sort(),
                    e = {
                      extra: { __serialized__: I(n) },
                      message:
                        'Non-Error exception captured with keys: ' + P(r),
                    }
                  if (t) {
                    var i = Nn(Tn(t).stack)
          ...
          return (
            ...
            (t.sdk = u({}, t.sdk, {
              ...
              packages: s((t.sdk && t.sdk.packages) || [], [
                { name: 'npm:@sentry/browser', version: '5.2.0' },
              ]),
              version: '5.2.0',
            })),
        ...
        throw (
          ...
          on(function (r) {
            r.addEventProcessor(function (n) {
              var r = u({}, n)
              return (
                t.mechanism && x(r, void 0, void 0, t.mechanism),
                (r.extra = u({}, r.extra, { arguments: C(e, 3) })),
                r
              )
            }),
              captureException(n)
  ...
  function Vn(n) {
    for (
      ...
      r &&
      i++ < 5 &&
      !('html' === (t = Kn(r)) || (i > 1 && o + e.length * u + t.length >= 80));
  ...
  var Zn = (function () {
      function n(t) {
        ;(this.name = n.id),
          (this.in = u({ onerror: !0, onunhandledrejection: !0 }, t))
      }
      return (
        (n.prototype.setupOnce = function () {
          ;(Error.stackTraceLimit = 50),
            ...
            this.in.onerror &&
              (k.log('Global Handler attached: onerror'), On()),
            this.in.onunhandledrejection &&
              (k.log('Global Handler attached: onunhandledrejection'), kn())
        }),
        (n.prototype.Ln = function (n) {
          if (!v(n.message) && 'onunhandledrejection' !== n.mechanism) {
            var t = n.message
            n.message =
              t.error && v(t.error.message)
                ? t.error.message
                : 'No error message'
          }
          var r = In(n),
          ...
          return (
            x(
              r,
              n.original ? F(JSON.stringify(C(n.original)), o) : '',
              'onunhandledrejection' === n.mechanism
                ? 'UnhandledRejection'
                : 'Error',
              { data: e, handled: !1, type: n.mechanism }
            ),
            r
          )
        }),
      ...
      return (
        ...
        (n.prototype.Pn = function (n) {
          ...
          r &&
            ...
            (R(r, 'addEventListener', function (t) {
        ...
        (n.prototype.setupOnce = function () {
          this.Mn = this.Mn
          var n = b()
          R(n, 'setTimeout', this.Fn.bind(this)),
            R(n, 'setInterval', this.Fn.bind(this)),
            R(n, 'requestAnimationFrame', this.Un.bind(this)),
            [
              'EventTarget',
              'Window',
              'Node',
    ...
    rt = (function () {
      ...
      return (
                  ...
                  R(tt.console, r, function (e) {
                    return function () {
                      ...
                      'assert' === r &&
                        ...
                        ((u.message =
                          'Assertion failed: ' +
                          (U(i.slice(1), ' ') || 'console.assert')),
                        (u.data.extra.arguments = C(i.slice(1), 3))),
        ...
        (t.prototype.qn = function () {
          'document' in tt &&
            (tt.document.addEventListener('click', Gn('click'), !1),
            ...
            ['EventTarget', 'Node'].forEach(function (n) {
              ...
              t &&
                ...
                (R(t, 'addEventListener', function (n) {
                  return function (t, r, e) {
                    return (
                      r && r.handleEvent
                        ? ('click' === t &&
                            R(r, 'handleEvent', function (n) {
                              return function (t) {
                                return Gn('click')(t), n.call(this, t)
                              }
                            }),
                          'keypress' === t && R(r, 'handleEvent', zn()))
                        : ('click' === t && Gn('click', !0)(this),
                          'keypress' === t && zn()(this)),
                      n.call(this, t, r, e)
                    )
                  }
        ...
        (t.prototype.Hn = function () {
          q() &&
            -1 !== b().fetch.toString().indexOf('native') &&
            R(tt, 'fetch', function (r) {
              return function () {
                ...
                'string' == typeof u
                  ? (o = u)
                  : 'Request' in tt && u instanceof Request
                ...
                if (a) {
                  ...
                  if (f && o.includes(f))
                    return (
                      'POST' === c && e[1] && e[1].body && et(e[1].body),
                      r.apply(tt, e)
                    )
                }
            ...
            R(n, 'open', function (n) {
              ...
              R(n, 'send', function (n) {
                return function () {
                  ...
                  return (
                    i.__sentry_own_request__ && et(r[0]),
                    ...
                    'function' == typeof i.onreadystatechange
                      ? R(i, 'onreadystatechange', function (n) {
                          return Jn(
                            n,
                            {
                              mechanism: {
