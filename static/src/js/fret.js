export default function initFRET(){
  ...
  $("#donor-select").select2({ theme: "bootstrap", containerCssClass: ':all:', width: 'auto'});
  $("#acceptor-select").select2({ theme: "bootstrap", containerCssClass: ':all:', width: 'auto'});
  ...
  function forster_distance(ar1, ar2, k2, ni){
    ...
    var r = Math.pow(8.8 * 1e-25 * k2 * donorQY * Math.pow(ni, -4) * overlapIntgrl, 1/6) * 1e7;
