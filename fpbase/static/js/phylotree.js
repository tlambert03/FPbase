!(function (t) {
                  ...
                  if (d.call(t, a))
                    if (
                      ...
                      for (s = 0, p = g.length; s < p; s++)
                        (i = g[s]), ((r = {})[a] = i), (u = this.element(r))
                    else
                      f(g)
                        ? (u = this.element(a)).element(g)
                        : (u = this.element(a, g))
              } else
                u =
                  !this.options.ignoreDecorators &&
      ...
      ;(e = function () {
        ...
        if (
          ...
          for (t = 0, n = o.length; t < n; t++)
            if (null != (r = o[t])) for (e in r) u.call(r, e) && (s[e] = r[e])
        return s
      }),
        (i = function (t) {
          return (
      ...
      ;(r = n(1).isObject),
        ...
        (t.exports = (function (t) {
          function n(t, e, i, o) {
            ...
            if (
              ((this.pe = !!e), (this.name = this.stringify.eleName(i)), r(o))
            ) {
              if (!o.pubID && !o.sysID)
                throw new Error(
        ...
        (t.exports = (function (t) {
          ...
          return (
            ...
            (n.prototype.attList = function (t, n, r, i, o) {
              var s
              return (
                (s = new e(this, t, n, r, i, o)), this.children.push(s), this
              )
            }),
      ...
      ;(r = n(1).isObject),
        ...
        (t.exports = (function (t) {
          function n(t, e, i, o) {
            ...
            n.__super__.constructor.call(this, t),
              r(e) &&
                ((e = (s = e).version), (i = s.encoding), (o = s.standalone)),
              e || (e = '1.0'),
        ...
        (t.exports = (function (t) {
          ...
          return (
            ...
            (n.prototype.clone = function () {
              ...
              (n.attributes = {}),
              (r = this.attributes)))
                a.call(r, e) && ((t = r[e]), (n.attributes[e] = t.clone()))
              return (
                (n.children = []),
  ...
  function (t, e, n) {
    ...
    ;(function (e, r, i) {
      ...
      function _(t) {
        if (((a = a || n(2)), !(d.call(_, this) || this instanceof a)))
          return new _(t)
          ...
          ? ((d = Function.prototype[Symbol.hasInstance]),
            Object.defineProperty(_, Symbol.hasInstance, {
              value: function (t) {
                return (
                  !!d.call(this, t) ||
                  (this === _ && t && t._writableState instanceof m)
                )
              },
            }))
          : (d = function (t) {
        ...
        (t.exports = (function (t) {
          ...
          return (
            ...
            (n.prototype.element = function (t, n) {
              ...
              (m = t.attributes)))
                y.call(m, d) && ((i = m[d]), (g += this.attribute(i)))
              if (
                0 === t.children.length ||
            ...
            (n.prototype.openNode = function (t, e) {
              ...
              if ((e || (e = 0), t instanceof l)) {
                ...
                (o = t.attributes)))
                  y.call(o, r) && ((n = o[r]), (i += this.attribute(n)))
        ...
        (b.prototype.resume = function () {
          ...
          return (
            t.flowing ||
              ...
              (function (t, e) {
                e.resumeScheduled ||
                  ((e.resumeScheduled = !0), i.nextTick(S, t, e))
              })(this, t)),
            this
          )
        }),
      ...
      t.exports = (function () {
        ...
        return (
          ...
          (t.prototype.space = function (t) {
            var e
            return this.pretty && (e = (t || 0) + this.offset + 1) > 0
              ? new Array(e).join(this.indent)
              : ''
          }),
          t
        )
  ...
  function (t, e, n) {
    ;(function (t) {
      !(function (e) {
            ...
            write: function (t) {
              ...
              for (; (r = Y(t, n++)), (this.c = r), r; )
                switch (
                  ...
                  case A.BEGIN:
                    if (((this.state = A.BEGIN_WHITESPACE), '\ufeff' === r))
                      continue
                    j(this, r)
                    continue
                  ...
                  case A.TEXT:
                    ...
                    (this.sawRoot && this.closedRoot && !this.strict)
                      ? (m(r) ||
                          ...
                          k(this, 'Text data outside of root node.'),
                        '&' === r
                          ? (this.state = A.TEXT_ENTITY)
                          : (this.textNode += r))
                      : ((this.state = A.OPEN_WAKA),
                        (this.startTagPosition = this.position))
                    continue
                  case A.SCRIPT:
                    '<' === r
                      ? (this.state = A.SCRIPT_ENDING)
                      : (this.script += r)
                    continue
                  case A.SCRIPT_ENDING:
                    '/' === r
                      ? (this.state = A.CLOSE_TAG)
                      : ((this.script += '<' + r), (this.state = A.SCRIPT))
                    continue
                  case A.OPEN_WAKA:
                    if ('!' === r)
                      (this.state = A.SGML_DECL), (this.sgmlDecl = '')
                    else if (m(r));
                    else if (w(p, r))
                      (this.state = A.OPEN_TAG), (this.tagName = r)
                    else if ('/' === r)
                      (this.state = A.CLOSE_TAG), (this.tagName = '')
                    else if ('?' === r)
                  ...
                  case A.SGML_DECL:
                    ;(this.sgmlDecl + r).toUpperCase() === u
                      ...
                      ? ((this.state = A.DOCTYPE),
                        ...
                        (this.sgmlDecl = ''))
                      : '>' === r
                      ? (N(this, 'onsgmldeclaration', this.sgmlDecl),
                        (this.sgmlDecl = ''),
                        (this.state = A.TEXT))
                      : _(r)
                      ? ((this.state = A.SGML_DECL_QUOTED),
                        (this.sgmlDecl += r))
                      : (this.sgmlDecl += r)
                    continue
                  ...
                  case A.DOCTYPE:
                    '>' === r
                      ...
                      : ((this.doctype += r),
                        '[' === r
                          ? (this.state = A.DOCTYPE_DTD)
                          : _(r) &&
                            ((this.state = A.DOCTYPE_QUOTED), (this.q = r)))
                    continue
                  ...
                  case A.DOCTYPE_DTD:
                    ;(this.doctype += r),
                      ']' === r
                        ? (this.state = A.DOCTYPE)
                        : _(r) &&
                          ((this.state = A.DOCTYPE_DTD_QUOTED), (this.q = r))
                    continue
                  case A.DOCTYPE_DTD_QUOTED:
                    ;(this.doctype += r),
                      r === this.q &&
                        ((this.state = A.DOCTYPE_DTD), (this.q = ''))
                    continue
                  case A.COMMENT:
                    '-' === r
                      ? (this.state = A.COMMENT_ENDING)
                      : (this.comment += r)
                    continue
                  case A.COMMENT_ENDING:
                    '-' === r
                      ? ((this.state = A.COMMENT_ENDED),
                        (this.comment = O(this.opt, this.comment)),
                        this.comment && N(this, 'oncomment', this.comment),
                        (this.comment = ''))
                      : ((this.comment += '-' + r), (this.state = A.COMMENT))
                    continue
                  case A.COMMENT_ENDED:
                    '>' !== r
                      ? (k(this, 'Malformed comment'),
                        (this.comment += '--' + r),
                        (this.state = A.COMMENT))
                      : (this.state = A.TEXT)
                    continue
                  case A.CDATA:
                    ']' === r
                      ? (this.state = A.CDATA_ENDING)
                      : (this.cdata += r)
                    continue
                  case A.CDATA_ENDING:
                    ']' === r
                      ? (this.state = A.CDATA_ENDING_2)
                      : ((this.cdata += ']' + r), (this.state = A.CDATA))
                    continue
                  case A.CDATA_ENDING_2:
                    '>' === r
                      ? (this.cdata && N(this, 'oncdata', this.cdata),
                        N(this, 'onclosecdata'),
                        (this.cdata = ''),
                        (this.state = A.TEXT))
                      : ']' === r
                  ...
                  case A.PROC_INST_ENDING:
                    '>' === r
                      ? (N(this, 'onprocessinginstruction', {
                    ...
                    w(d, r)
                      ...
                      : (L(this),
                        '>' === r
                          ? B(this)
                          : '/' === r
                          ? (this.state = A.OPEN_TAG_SLASH)
                          : (m(r) || k(this, 'Invalid character in tag name'),
                            (this.state = A.ATTRIB)))
                    continue
                  ...
                  case A.ATTRIB_NAME:
                    '=' === r
                      ...
                      ? (k(this, 'Attribute without value'),
                        ...
                        B(this))
                      : m(r)
                      ? (this.state = A.ATTRIB_NAME_SAW_WHITE)
                      : w(d, r)
                      ? (this.attribName += r)
                      : k(this, 'Invalid attribute name')
                    continue
                  ...
                  case A.ATTRIB_VALUE:
                    if (m(r)) continue
                    _(r)
                      ? ((this.q = r), (this.state = A.ATTRIB_VALUE_QUOTED))
                      : (k(this, 'Unquoted attribute value'),
                  ...
                  case A.ATTRIB_VALUE_QUOTED:
                    if (r !== this.q) {
                      '&' === r
                        ? (this.state = A.ATTRIB_VALUE_ENTITY_Q)
                        : (this.attribValue += r)
                      continue
                    }
                  ...
                  case A.ATTRIB_VALUE_CLOSED:
                    m(r)
                      ...
                      ? (this.state = A.OPEN_TAG_SLASH)
                      : w(p, r)
                      ? (k(this, 'No whitespace between attributes'),
                        (this.attribName = r),
                        (this.attribValue = ''),
                        (this.state = A.ATTRIB_NAME))
                      : k(this, 'Invalid attribute name')
                  ...
                  case A.ATTRIB_VALUE_UNQUOTED:
                    if (!b(r)) {
                      '&' === r
                        ? (this.state = A.ATTRIB_VALUE_ENTITY_U)
                        : (this.attribValue += r)
                      continue
                    }
                    ...
                    if (this.tagName)
                      '>' === r
                        ...
                        ? ((this.script += '</' + this.tagName),
                          (this.tagName = ''),
                          (this.state = A.SCRIPT))
                        : (m(r) || k(this, 'Invalid tagname in closing tag'),
                      ...
                      v(p, r)
                        ? this.script
                          ? ((this.script += '</' + r), (this.state = A.SCRIPT))
                          : k(this, 'Invalid tagname in closing tag.')
                        : (this.tagName = r)
                    }
                    continue
                  case A.CLOSE_TAG_SAW_WHITE:
                    ...
                    '>' === r
                      ? U(this)
                      : k(this, 'Invalid characters in closing tag')
                    continue
                  case A.TEXT_ENTITY:
                  ...
                  case A.ATTRIB_VALUE_ENTITY_U:
                    ...
                    ';' === r
                      ? ((this[l] += F(this)),
                        (this.entity = ''),
                        (this.state = a))
                      : w(this.entity.length ? g : y, r)
                      ? (this.entity += r)
                      : (k(this, 'Invalid character in entity name'),
        ...
        function B(t, e) {
          if (t.opt.xmlns) {
            ...
            ;(n.prefix = r.prefix),
              ...
              n.prefix &&
                !n.uri &&
                (k(t, 'Unbound namespace prefix: ' + JSON.stringify(t.tagName)),
                (n.uri = r.prefix))
            ...
            for (var o = 0, s = t.attribList.length; o < s; o++) {
              ...
              h &&
                'xmlns' !== h &&
                !p &&
                (k(t, 'Unbound namespace prefix: ' + JSON.stringify(h)),
                (d.uri = h)),
        ...
        function j(t, e) {
          '<' === e
            ? ((t.state = A.OPEN_WAKA), (t.startTagPosition = t.position))
            : m(e) ||
        ...
        (e.Parser = (function (n) {
          function f(t) {
            ...
            for (n in ((this.options = {}), (i = r[0.2])))
              h.call(i, n) && ((o = i[n]), (this.options[n] = o))
          ...
          return (
                ...
                (this.saxParser.onclosetag = (function (t) {
                  return function () {
                    ...
                    return r.length > 0
                      ...
                      : (t.options.explicitRoot && ((p = l), ((l = {})[c] = p)),
                        (t.resultObject = l),
                        (t.saxParser.ended = !0),
            ...
            (f.prototype.parseString = function (e, n) {
              ...
              try {
                ...
                if (
                  ((r = t), !this.saxParser.errThrown && !this.saxParser.ended)
                )
      ...
      ;(u = n(18)),
        ...
        (t.exports = (function (t) {
          ...
          return (
            ...
            (n.prototype.document = function (t) {
              var e, n, i, o, s, a, l, f
              for (n = 0, o = (a = t.children).length; n < o; n++)
            ...
            (n.prototype.element = function (t, n) {
              ...
              (c = t.attributes)))
                y.call(c, u) && ((i = c[u]), this.attribute(i))
              if (
                0 === t.children.length ||
                t.children.every(function (t) {
                  return '' === t.value
          ...
          return (
            ...
            (t.prototype.instruction = function (t, e) {
              ...
              if (
                ...
                for (r in t)
                  v.call(t, r) && ((i = t[r]), this.instruction(r, i))
              else
                m(e) && (e = e.apply()),
                  (s = new f(this, t, e)),
                  this.onData(
                    ...
                    for (p in e)
                      if (a.call(e, p))
                        if (((c = e[p]), p === n)) {
                          ...
                          'object' == typeof c
                            ? (t = u(t.ele(p), c).up())
                            : 'string' == typeof c && h.options.cdata && o(c)
    ...
    ;(function () {
      ...
      function c(t, e, n) {
        ...
        if (t.radial()) {
          var i = t.pad_width(),
            o =
              'fit-to-size' != t.options()['top-bottom-spacing']
                ? t.pad_height()
                : 0
          ;(r = [r[1] + 2 * i, r[0] + 2 * i + o]),
            e &&
              e
                .selectAll('.' + t.css_classes()['tree-container'])
                .attr('transform', 'translate (' + i + ',' + (i + o) + ')')
        } else
          r = [
            r[1] +
              ('fit-to-size' != t.options()['left-right-spacing']
                ? t.pad_width()
                : 0),
            r[0] +
              ('fit-to-size' != t.options()['top-bottom-spacing']
      ...
      function d(t) {
        return [t.branch, t['selected-branch'], t['tagged-branch']].reduce(
          function (t, e, n, r) {
      ...
      function g(t, e) {
        ...
        function i(e) {
          return {
            ...
            error:
              ...
              t[e] +
              "' in '" +
              t.substring(e - 20, e + 1) +
              '[ERROR HERE]' +
              t.substring(e + 1, e + 20) +
              "'",
          }
        }
        var o = 0,
        ...
        return 1 != n.length
          ? i(t.length - 1)
          : (s.length && (h.name = s), { json: h, error: null })
      }
      function m(e) {
                  ...
                  ? (function (t) {
                      function e(t, n) {
                        t.clade &&
                          ...
                          t.taxonomy &&
                            (t.name = t.taxonomy[0].scientific_name[0]),
                          (t.annotation = '')
                      }
                      var n
                      return (
                        i(t, function (t, r) {
                          ;((n = r.phyloxml.phylogeny[0].clade[0]).name =
                            'root'),
                            e(n)
                        }),
                        { json: n, error: null }
          ...
          return (
            ...
            (et.placenodes = function () {
              ...
              function p(t) {
                var e = 0
                if (
                  ((t.x = t.children.map(d).reduce(function (t, n) {
                    return 'number' == typeof n ? t + n : ((e += 1), t)
                  }, 0)),
                  e == t.children.length)
                )
                  return (t.notshown = !0), void (t.x = void 0)
              ...
              function d(d) {
                if (!o(d)) {
                  ...
                  if (y) {
                    ...
                    ;(t = d.x = t + S(n, d) + 0.5 * (r + g)),
                      (e[1][1] = Math.max(e[1][1], d.y)),
                      (e[1][0] = Math.min(e[1][0], d.y - 0.5 * g)),
                      (e[0][1] = c
                        ? Math.max(
                            e[0][1],
                            i +
                              (d.x - i) * F.compression +
                              s +
                              (0.5 * g + S(n, d)) * F.compression
                          )
                        : Math.max(e[0][1], t + 0.5 * g + S(n, d))),
                      (n = d),
                      (r = g)
                  } else {
                    if (f(d) && !c) {
                      if (
                        ...
                        var m = function (e) {
                          ;(e.hidden = !0),
                            l(e)
                              ? ((t = e.x = i + (e.x - i) * F.compression + s),
                                d.collapsed.push([e.x, e.y]))
                              : e.children.map(m)
                        }
                        ;(t = i),
                          m(d),
              ...
              function g() {
                if (
                  ...
                  0.5 * t < label_width &&
                    ((shown_font_size *= (0.5 * t) / label_width),
                    (label_width = 0.5 * t)),
                    (G[1] =
                      (I[1] - Q[1] - F['left-offset'] - label_width) / e[1][1])
                }
              }
              if (
                ((draw_scale_bar = F['show-scale'] && a),
                'fixed-step' == F['top-bottom-spacing']
                  ? ((Q[1] = Math.max(H, -e[1][0] * X[0])),
                    (I[0] = e[0][1] * X[0]),
                    (G[0] = X[0]))
                  : ((G[0] = (I[0] - et.pad_height()) / e[0][1]), (y = !0)),
                ...
                Y.forEach(function (t) {
                  ...
                  ;(t.angle = (2 * Math.PI * e) / v),
                    ...
                    (t.text_angle =
                      (t.text_angle ? 180 : 0) + (180 * t.angle) / Math.PI)
                }),
                  g(),
                  Y.forEach(function (t) {
                ...
                Y.forEach(function (t) {
                    ...
                    if (null !== m) {
                      ...
                      if (i > F['max-radius']) {
                        var o = n / F['max-radius'],
                          ...
                          a =
                            t.radius * b -
                            (o * o - (b - t.radius) * (b - t.radius)) /
                              2 /
                              (1 - Math.cos(m - t.angle)),
                          u = Math.sqrt(s * s - 4 * a)
                  ...
                  (radius = Math.min(
                    F['max-radius'],
                    Math.max(v / 2 / Math.PI, w)
                  )),
                  y &&
                    (radius = Math.min(
                      radius,
                      0.5 * (Math.min(v, e[1][1] * G[1]) - label_width) -
                        radius * T
                    )),
                ...
                g(),
                  ...
                  Y.forEach(function (t) {
                    if (
                      ((t.x *= G[0]),
                      (t.y *= G[1]),
                      'right-to-left' == F.layout &&
                        (t.y = e[1][1] * G[1] - t.y),
                      l(t) &&
                        (right_most_leaf = Math.max(
                          right_most_leaf,
                          t.y + et.node_bubble_size(t)
                        )),
                      t.collapsed)
                    ) {
              ...
              if (draw_scale_bar) {
                ...
                if (et.radial()) {
                  if (
                    ((D = Math.min(radius / 5, 50)),
                    (D =
                      (A = Math.pow(
                        10,
                        Math.ceil(
                          Math.log((e[1][1] * D) / radius) / Math.log(10)
                        )
                      )) *
                      (radius / e[1][1])) < 30)
                  ) {
                ...
                var C = d3.scale
                    .linear()
                    .domain([0, A])
                    .range([shown_font_size, shown_font_size + D]),
                  k = d3.format('.2g')
                if (
                  ...
                  ;(L = L.length > 1 ? L[1] : L[0]),
                    draw_scale_bar.ticks(
                      Math.min(
                        10,
                        d3.round(D / (shown_font_size * k(L).length * 0.8), 0)
                      )
                    )
                }
            ...
            (et.selection_label = function (t) {
              return arguments.length
                ? ((selection_attribute_name = t), et.sync_edge_labels(), et)
                : selection_attribute_name
            }),
            (et.handle_node_click = function (t) {
              var e = d3
                .select(A.container)
                .select('#d3_layout_phylotree_context_menu')
              if (
                (e.empty() &&
                  (e = d3
                    .select(A.container)
                    .append('ul')
                    .attr('id', 'd3_layout_phylotree_context_menu')
                ...
                l(t) ||
                  (F.collapsible &&
                    (e
                      ...
                      .append('a')
                      .attr('tabindex', '-1')
                      .text(f(t) ? 'Expand Subtree' : 'Collapse Subtree')
                      .on('click', function (n) {
                  ...
                  F.selectable &&
                    (e
                      ...
                      .on('click', function (n) {
                        e.style('display', 'none'),
                          et.modify_selection(
                            et.select_all_descendants(t, !0, !0)
                          )
                      }),
                    e
                      .append('li')
                      ...
                      .on('click', function (n) {
                        e.style('display', 'none'),
                          et.modify_selection(
                            et.select_all_descendants(t, !0, !1)
                          )
                      }),
                    e
                      .append('li')
                      ...
                      .on('click', function (n) {
                        e.style('display', 'none'),
                          et.modify_selection(
                            et.select_all_descendants(t, !1, !0)
                          )
                      }))),
                  t.parent &&
                    (F.selectable &&
                    ...
                    F.hide &&
                      e
                        ...
                        .append('a')
                        .attr('tabindex', '-1')
                        .text('Hide this ' + (l(t) ? 'node' : 'subtree'))
                        .on('click', function (n) {
                          e.style('display', 'none'),
                            et
                              .modify_selection([t], 'notshown', !0, !0)
                ...
                var n = []
                'menu_items' in t &&
                  'object' == typeof t.menu_items &&
                  t.menu_items.forEach(function (e) {
                    3 == e.length &&
                      ((e[2] && !e[2](t)) || n.push([e[0], e[1]]))
                  }),
                  n.length &&
                    (e.append('li').attr('class', 'divider'),
            ...
            (et.update_layout = function (e, n) {
              var r, i
              n &&
                (Y = D.call(this, e)).forEach(function (t) {
                  t.id = null
                }),
                et.placenodes(),
                (z = et.links(Y)),
            ...
            (et.sync_edge_labels = function () {
              if (
                (z.forEach(function (t) {
                  ;(t[selection_attribute_name] =
                    t.target[selection_attribute_name] || !1),
            ...
            (et.modify_selection = function (t, e, n, r, i) {
              ...
              if (
                (!F['restricted-selectable'] && !F.selectable) ||
                F['binary-selectable']
              ) {
                if (
                  F['binary-selectable'] &&
            ...
            (et.node_bubble_size = function (t) {
              return F['draw-size-bubbles']
                ? 0.5 * ((O(t) / rescale_node_span) * G[0])
                : 0
            }),
            (et.shift_tip = function (t) {
              return F['is-radial']
                ? [
                    ('end' == t.text_align ? -1 : 1) *
                      (radius_pad_for_bubbles - t.radius),
                    0,
                  ]
                : (F['right-to-left'], [right_most_leaf - t.screen_x, 0])
            }),
            ...
            (et.count_handler = function (t) {
              return arguments.length
                ? ((count_listener_handler = t), et)
                : count_listener_handler
            }),
            (et.layout_handler = function (t) {
              return arguments.length
                ? ((layout_listener_handler = t), et)
                : layout_listener_handler
            }),
            (et.internal_label = function (t, n) {
              ...
              for (var r = Y.length - 1; r >= 0; r--) {
                var i = Y[r]
                l(i) ||
                  e(i, selection_attribute_name) ||
                  (i[selection_attribute_name] = t(i.children))
              }
              ...
              et.clear_internal_nodes(t),
                (function t(e) {
                  if (
                    ...
                    e[selection_attribute_name]
                      ? ((e.mp[0][0] = r + 1),
                        (e.mp[1][0] = !0),
                        (e.mp[0][1] = r),
                        (e.mp[1][1] = !0))
                      : (n < r + 1
                          ? ((e.mp[0][0] = n), (e.mp[1][0] = !1))
                          : ((e.mp[0][0] = r + 1), (e.mp[1][0] = !0)),
                        r < n + 1
                          ? ((e.mp[0][1] = r), (e.mp[1][1] = !0))
                          : ((e.mp[0][1] = n + 1), (e.mp[1][1] = !1)))
                  }
                })(Y[0]),
                Y.forEach(function (t) {
                  t.parent
                    ? (t.mp = t.mp[1][t.parent.mp ? 1 : 0])
                    : (t.mp = t.mp[1][t.mp[0][0] < t.mp[0][1] ? 0 : 1])
                }),
                et.modify_selection(function (t, e) {
                  return l(t.target)
                  ...
                  n >= 0 &&
                    ...
                    e.parent.children.length > 2
                      ...
                      ? ((e.parent.parent.children[
                          e.parent.parent.children.indexOf(e.parent)
                        ] = e.parent.children[1 - n]),
                        (e.parent.children[1 - n].parent = e.parent.parent),
                        Y.splice(Y.indexOf(e.parent), 1))
                      : (Y.splice(0, 1),
                        (Y[0].parent = null),
            ...
            (et.reroot = function (t) {
              if (t.parent) {
                ...
                if (n.parent) {
                  for (
                    t.__mapped_bl =
                      void 0 === t.__mapped_bl ? void 0 : 0.5 * t.__mapped_bl,
                      r = n.__mapped_bl,
                      n.__mapped_bl = t.__mapped_bl,
                      new_json.children.push(n);
                    n.parent;

                  ) {
                    var i = n.children.indexOf(e)
                    n.parent.parent
                      ? n.children.splice(i, 1, n.parent)
            ...
            (et.spacing_x = function (t, e) {
              return arguments.length
                ? (X[0] != t &&
                    t >= F['minimum-per-node-spacing'] &&
                    t <= F['maximum-per-node-spacing'] &&
                    ((X[0] = t), e || et.placenodes()),
                  et)
                : X[0]
            }),
            (et.spacing_y = function (t, e) {
              return arguments.length
                ? (X[1] != t &&
                    t >= F['minimum-per-level-spacing'] &&
                    t <= F['maximum-per-level-spacing'] &&
                    ((X[1] = t), e || et.placenodes()),
                  et)
                : X[1]
            }),
            ...
            (et.update_has_hidden_nodes = function () {
              for (k = Y.length - 1; k >= 0; k -= 1)
                l(Y[k])
                  ? (Y[k].has_hidden_nodes = Y[k].notshown)
                  : (Y[k].has_hidden_nodes = Y[k].children.reduce(function (
                      t,
                      e
                    ) {
                      return e.notshown || t
            ...
            (et.length = function (t) {
              return arguments.length
                ? (default_length_attribute != t &&
                    ((default_length_attribute = t), (M = !0)),
                  et)
                : default_length_attribute
            }),
            (et._label_width = function (t) {
              t = t || shown_font_size
              var e = 0
              return (
                Y.filter(n).forEach(function (n) {
                  var r = R(n).length * t * 0.6
                  null !== n.angle &&
                    (r *= Math.max(
                      Math.abs(Math.cos(n.angle)),
                      Math.abs(Math.sin(n.angle))
                    )),
                    (e = Math.max(r, e))
                }),
                e
            ...
            (et.node_circle_size = function (t, e) {
              return arguments.length
                ? ((F.node_circle_size = d3.functor(void 0 === t ? 3 : t)), et)
                : F.node_circle_size
            }),
            ...
            (et.svg = function (t) {
              return arguments.length
                ? (B !== t &&
                    ((B = t),
                    'phylotree-container' == j['tree-container'] &&
                      (B.selectAll('*').remove(),
                      (svg_defs = B.append('defs'))),
                    d3.select(A.container).on(
                      'click',
                      function (t) {
            ...
            (et.update = function (t) {
              ...
              if (
                (r.enter().append('g').attr('class', j['tree-container']),
              ...
              t
                ? (g.exit().transition().remove(),
                  (g = g
                    .attr('transform', function (t) {
                      if (
                        !_.isUndefined(t.screen_x) &&
                        !_.isUndefined(t.screen_y)
                      )
                        return (
                          'translate(' + t.screen_x + ',' + t.screen_y + ')'
                        )
                    })
                    .transition()))
                : g.exit().remove(),
                g
                  ...
                  .attr('class', et.reclass_node)
                  .each(function (e) {
                    et.draw_node(this, e, t)
                  }),
                F['label-nodes-with-name'] &&
                  g.attr('id', function (t) {
                    return 'node-' + t.name
                  })
              var m = c(et, B, t)
              if (F.brush) {
                ...
                b.enter()
                  ...
                  .attr('class', j['tree-selection-brush'])
                var w = d3.svg
                  .brush()
                  .x(
                    d3.scale
                      .identity()
                      .domain([0, m[0] - Q[1] - F['left-offset']])
                  )
                  .y(d3.scale.identity().domain([0, m[1] - et.pad_height()]))
                  .on('brush', function () {
                    var t = d3.event.target.extent(),
                      e = z
                        ...
                        .filter(function (e, n) {
                          return (
                            e.source.screen_x >= t[0][0] &&
                            e.source.screen_x <= t[1][0] &&
                            e.source.screen_y >= t[0][1] &&
                            e.source.screen_y <= t[1][1] &&
                            e.target.screen_x >= t[0][0] &&
                            e.target.screen_x <= t[1][0] &&
                            e.target.screen_y >= t[0][1] &&
                            e.target.screen_y <= t[1][1]
                          )
                        })
                        .map(function (t) {
                          return t.target
            ...
            (et.reclass_edge = function (t) {
              var n = j.branch
              return (
                u(t) && (n += ' ' + j['tagged-branch']),
                e(t, selection_attribute_name) &&
                  (n += ' ' + j['selected-branch']),
                n
              )
            }),
            ...
            (et.select_all_descendants = function (t, e, n) {
              ...
              return (
                (function i(o) {
                  l(o)
                    ? e && o != t && r.push(o)
                    : (n && o != t && r.push(o), o.children.forEach(i))
                })(t),
                r
              )
            }),
              ...
              if (((t = d3.select(t)), l(e))) {
                ...
                if (
                  ...
                  et.radial()
                    ? (n ? r.transition() : r)
                        .attr('transform', function (t) {
                          return (
                            T(t.text_angle) +
                            E(et.align_tips() ? et.shift_tip(t) : null)
                          )
                        })
                  ...
                  et.align_tips()
                    ? ((i = i.data([e])),
                      ...
                      i.classed(j['branch-tracer'], !0))
                    : i.remove(),
                  F['draw-size-bubbles'])
                ) {
                  var o = et.node_bubble_size(e)
                  ;(s = t.selectAll('circle').data([o]))
                    .enter()
                    .append('circle'),
                    n && (s = s.transition()),
                    s.attr('r', function (t) {
                    ...
                    shown_font_size >= 5 &&
                      r.attr('dx', function (t) {
                        return (
                          ('end' == t.text_align ? -1 : 1) *
                          ((et.align_tips() ? 0 : o) + 0.33 * shown_font_size)
                        )
                      })
                } else
                  shown_font_size >= 5 &&
                ...
                a > 0
                  ? (s.enter().append('circle'),
                    s
                      .attr('r', function (t) {
                        return Math.min(0.75 * shown_font_size, a)
                      })
                      .on('click', function (t) {
                        et.handle_node_click(t)
                      }))
